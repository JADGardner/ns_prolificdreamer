...
@dataclass
class ProlificDreamerPipelineConfig(VanillaPipelineConfig):
    """Configuration for pipeline instantiation"""

    _target: Type = field(default_factory=lambda: ProlificDreamerPipeline)
...
class ProlificDreamerPipeline(VanillaPipeline):
    ...
    def __init__(
        self,
        config: ProlificDreamerPipelineConfig,
        device: str,
